...
export const metadata: Metadata = {
  ...
  description:
    "Read the terms and conditions for using Graphics Garage services.",
};
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-muted-professional leading-relaxed">
                  By accessing and using Graphics Garage
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed mb-4">
                  Graphics Garage provides digital design
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-professional">
                  ...
                  <li>
                    Respond to requests for feedback in a
                    timely manner
                  </li>
                  <li>
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed mb-4">
                  ...
                  individual project agreements. Generally:
                </p>
                <ul className="list-disc pl-6 space-y-2 text-muted-professional">
                  <li>
                    A deposit may be required before work
                    begins
                  </li>
                  <li>
                    Payments are due within 30 days of
                    invoice date
                  </li>
                  <li>
                  ...
                  <li>
                    Work may be suspended for overdue
                    accounts
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed">
                  ...
                  Graphics Garage retains the right to use
                  completed work for portfolio and marketing
                  purposes unless otherwise agreed in
                  writing.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed">
                  ...
                  written notice. Upon termination, payment
                  is due for all work completed to date.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-purple-primary/5 rounded-lg border border-purple-primary/20">
                  ...
                  <p className="text-muted-professional">
                    Email: legal@graphicsgarage.com
                  </p>
                  <p className="text-muted-professional">
