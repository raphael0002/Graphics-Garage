...
export const PortfolioSection = () => {
    ...
    const filteredProjects = filter === "All" ? portfolioData : portfolioData.filter((item) => item.category === filter)
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-professional mb-8">
                        Featured Projects<span className="text-purple-primary">.</span>
                    </h2>
                    ...
                    <div className="flex flex-wrap justify-center gap-2 md:gap-4">
                        {categories.map((category) => (
                            <button
                                ...
                                className={`px-4 md:px-6 py-2 md:py-3 rounded-xl font-medium transition-all duration-300 ${filter === category
                    ...
                    {filteredProjects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="p-6">
                                ...
                                <p className="text-muted-professional text-sm leading-relaxed mb-4">{project.description}</p>
                                ...
                                <div className="space-y-1">
                                    {project.results.slice(0, 2).map((result, resultIndex) => (
                                        <div key={resultIndex} className="flex items-center text-xs text-muted-professional">
