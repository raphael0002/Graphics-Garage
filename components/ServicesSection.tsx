...
const services = [
    ...
    },
    {
        ...
        illustration: (
            <div className="relative w-20 h-16">
                <div className="absolute top-0 right-0 w-8 h-6 bg-gray-light rounded-md"></div>
                <div className="absolute top-2 right-2 w-4 h-4 bg-purple-primary rounded-full"></div>
                <div className="absolute bottom-0 right-4 w-12 h-8 bg-gray-dark rounded-lg"></div>
                <div className="absolute bottom-2 right-6 w-3 h-3 bg-purple-dark rounded-full"></div>
            </div>
        ),
    },
    {
        ...
        <section id="services" className="py-12 md:py-20 section-light transition-colors duration-300">
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8 mb-12">
                    ...
                    >
                        <div className="inline-flex items-center space-x-4 text-professional cursor-pointer hover:text-purple-primary transition-colors duration-300 group">
