                    ...
                    <CardContent className="p-6 md:p-8">
                      <div className="flex items-center mb-6">
                        ...
                        <div className="flex-1">
                          <h4 className="text-professional font-semibold text-base">
                            {testimonial.name}
                          </h4>
                          <p className="text-muted-professional text-sm">
                            {testimonial.title}
                          </p>
                          <p className="text-muted-professional text-sm opacity-75">
                            {testimonial.company}
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="text-right">
                    <div className="flex items-center justify-end mb-2 md:mb-3">
                      {[
                        ...
                        <Star
                          key={i}
                          className="w-4 md:w-6 h-4 md:h-6 text-yellow-400 fill-current mr-1"
                        />
                      ))}
                    </div>
                    <Badge
