...
export const metadata: Metadata = {
  ...
  description:
    "Learn about how Graphics Garage uses cookies and similar technologies.",
};
...
export default function CookiePolicyPage() {
  return (
    <main className="relative min-h-screen">
      ...
      <section className="pt-10 md:pt-36 pb-16 md:pb-20 section-light transition-colors duration-300">
            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-muted-professional leading-relaxed">
                  ...
                  when you visit our website. They are
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-professional">
                  ...
                  <li>
                    ...
                    us understand how visitors use our
                    website
                  </li>
                  <li>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-muted-professional leading-relaxed">
                      ...
                      switched off. They are usually set in
                      response to actions made by you such
                      as setting privacy preferences or
                      filling in forms.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-muted-professional leading-relaxed">
                      ...
                      site. These cookies help us improve
                      our website by understanding which
                  ...
                  <div>
                    ...
                    <p className="text-muted-professional leading-relaxed">
                      ...
                      make to improve your experience, such
                      as your preferred language or theme
                      settings.
                    </p>
                  </div>
                </div>
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed mb-4">
                  We may use third-party services that set
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-muted-professional">
                  <li>
                    Use your browser settings to block or
                    delete cookies
                  </li>
                  <li>
                    Use our cookie consent banner to manage
                    preferences
                  </li>
                  <li>
                    Opt out of Google Analytics using their
                    opt-out tool
                  </li>
                ...
                <p className="text-muted-professional leading-relaxed mt-4">
                  Please note that blocking certain cookies
              ...
              <section>
                ...
                <p className="text-muted-professional leading-relaxed">
                  ...
                  to time. Any changes will be posted on
              ...
              <section>
                ...
                <div className="mt-4 p-4 bg-purple-primary/5 rounded-lg border border-purple-primary/20">
                  ...
                  <p className="text-muted-professional">
                    Email: privacy@graphicsgarage.com
                  </p>
                  <p className="text-muted-professional">
