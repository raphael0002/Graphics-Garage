    ...
    return (
        <footer className="section-light border-t border-border py-12 md:py-4 transition-colors duration-300">
            <div className="container mx-auto px-4 md:px-6 sm:mb-10 pt-8">
                                        ...
                                        <li key={link}>
                                            {isHashLink ? (
                                                <button
                                                    ...
                                                    className="text-muted-professional hover:text-purple-primary transition-colors duration-200 text-left"
                                                >
                                                    {link}
                                                </button>
                                            ) : (
                ...
                >
                    <p className="text-muted-professional text-md mb-4 md:mb-0">© 2025 Graphics Garage. All rights reserved.</p>
                </motion.div>
            </div>
        </footer>
    )
