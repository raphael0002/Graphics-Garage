            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center mt-20">
                    ...
                    >
                        We Are Digital
                        <br />
                        <span className="text-purple-primary">Innovators</span>
                    </motion.h1>
                    ...
                    >
                        Founded with a passion for digital excellence, Graphics Garage has been transforming businesses through
                        innovative design and technology solutions. We believe in the power of creativity combined with strategic
                    ...
                    >
                        <div className="card-professional rounded-2xl p-6 md:p-8 text-center hover:border-purple-primary transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-professional mb-3">Our Mission</h3>
                        ...
                        <div className="card-professional rounded-2xl p-6 md:p-8 text-center hover:border-purple-primary transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-professional mb-3">Our Vision</h3>
                            <p className="text-muted-professional leading-relaxed">
                                To be the leading digital agency that transforms ideas into extraordinary digital experiences.
                            </p>
                        </div>
                        ...
                        <div className="card-professional rounded-2xl p-6 md:p-8 text-center hover:border-purple-primary transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-professional mb-3">Our Values</h3>
                            <p className="text-muted-professional leading-relaxed">
