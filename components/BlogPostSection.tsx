...
export const BlogPostSection = ({
  ...
  const formatContent = (content: string) => {
    return content
      .replace(
        /^# (.*$)/gm,
        '<h1 class="text-3xl font-bold text-gray-900 dark:text-white mb-6 mt-8">$1</h1>'
      )
      .replace(
        /^## (.*$)/gm,
        '<h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4 mt-6">$1</h2>'
      )
      .replace(
        /^### (.*$)/gm,
        '<h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-4">$1</h3>'
      )
      .replace(
        /\*\*(.*?)\*\*/g,
      ...
      .replace(
        /^- (.*$)/gm,
        '<li class="ml-4 mb-2 text-gray-700 dark:text-white">$1</li>'
      )
      .replace(
        /\n\n/g,
        '</p><p class="mb-4 text-gray-700 dark:text-white leading-relaxed">'
      )
      .replace(
        /^(?!<[h|l])/gm,
        '<p class="mb-4 text-gray-700 dark:text-white leading-relaxed">'
      )
      .replace(
        /<\/p><p class="mb-4 text-gray-700 dark:text-white leading-relaxed">$/g,
        "</p>"
      );
  };
      ...
      <div className="w-full max-w-[min(90vw,85rem)] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Excerpt */}
            <p className="text-xl md:text-2xl dark:text-white text-gray-900 leading-relaxed mb-8">
              {post.excerpt}
            </p>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-purple-primary leading-relaxed">
                  {post.author.name} is a talented member of
                  the Graphics Garage team, bringing
                  creativity and expertise to every project.
                  With a passion for design and innovation,
                  they contribute valuable insights to our
                  blog and help our clients achieve their
                  visual goals.
                </p>
              </div>
            </div>
