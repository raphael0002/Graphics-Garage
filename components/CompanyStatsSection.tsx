...
const stats = [
    ...
    },
    {
        ...
        description: "Years of expertise in digital solutions and design",
    },
]
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-professional mb-4">
                        Our Impact in Numbers<span className="text-purple-primary">.</span>
                    </h2>
                    <p className="text-lg md:text-xl text-muted-professional max-w-3xl mx-auto">
                        These numbers represent our commitment to delivering exceptional results and building lasting relationships
                        with our clients.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
                    {stats.map((stat, index) => (
                        ...
                        >
                            ...
                            <div className="text-3xl md:text-4xl font-bold text-purple-primary mb-2">{stat.number}</div>
                            <h3 className="text-lg font-semibold text-professional mb-2">{stat.label}</h3>
                            <p className="text-sm text-muted-professional leading-relaxed">{stat.description}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
