...
export const WorkSection = () => {
    return (
        <section className="min-h-[60vh] flex items-center justify-center relative overflow-hidden section-light transition-colors duration-300">
            {/* Background Elements */}
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="text-center mt-20">
                    ...
                    >
                        Our Creative
                        <br />
                        <span className="text-purple-primary">Works</span>
                    </motion.h1>
                    ...
                    >
                        Explore our portfolio of successful projects that showcase our expertise in creating exceptional digital
                        experiences for businesses across various industries.
                    </motion.p>
                </div>
            </div>
        </section>
