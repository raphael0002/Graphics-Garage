            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-professional mb-4">
                        What Drives Us Forward<span className="text-purple-primary">.</span>
                    </h2>
                    <p className="text-lg md:text-xl text-muted-professional max-w-3xl mx-auto">
                        Our values are the compass that guides every decision we make and every solution we create for our clients.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                    {values.map((value, index) => (
                        ...
                        >
                            ...
                            <div>
                                <h3 className="text-xl md:text-2xl font-bold text-professional mb-3">{value.title}</h3>
                                <p className="text-muted-professional leading-relaxed">{value.description}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
