...
export const ServiceSection = ({ service }: ServiceHeroSectionProps) => {
        ...
        return (
            <section className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-4xl font-bold text-professional mb-4">Service Not Found</h1>
                    <p className="text-muted-professional">The requested service could not be found.</p>
                </div>
            </section>
        )
    }
    ...
    return (
        <section className="min-h-screen flex items-center justify-center relative overflow-hidden section-light transition-colors duration-300">
            {/* Background Elements */}
            ...
            <div className="container mx-auto px-4 md:px-6 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-center mt-20">
                    ...
                    >
                        ...
                        >
                            <Icon name={service.iconName} className="w-4 h-4 mr-2" />
                            {service.title}
                        </motion.div>
                        ...
                        >
                            Professional
                            <br />
                            <span className="text-purple-primary">{service.title}</span>
                        </motion.h1>
                        ...
                        >
                            <div>
                                ...
                                <div className="text-sm text-muted-professional">{service.stats.label}</div>
                            </div>
                            {service.stats.secondary && (
                                <div>
                                    <div className="text-2xl md:text-3xl font-bold text-purple-primary">{service.stats.secondary}</div>
                                    <div className="text-sm text-muted-professional">{service.stats.secondaryLabel}</div>
                                </div>
                            )}
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        <div className="card-professional rounded-2xl p-6 md:p-8">
                            <h3 className="text-xl md:text-2xl font-bold text-professional mb-6">Key Benefits</h3>
                            <div className="space-y-4">
                                {service.benefits?.map((benefit, index) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-muted-professional">{benefit}</span>
                                    </motion.div>
                                )) || []}
                            </div>
                        </div>
                        ...
                        {/* Technologies */}
                        <div className="card-professional rounded-2xl p-6 md:p-8">
                            <h3 className="text-xl md:text-2xl font-bold text-professional mb-6">Technologies We Use</h3>
